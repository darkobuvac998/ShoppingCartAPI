...
pipeline {
    ...
    environment {
        ...
        GIT_COMMIT_HASH = getShortCommitHash()
        GIT_COMMIT_AUTHOR = getCommitAuthorName()
        GIT_COMMIT_MESSAGE = getCommitMessage()
        GIT_COMMIT_AUTHOR_EMAIL = getCommitAuthorEmail()
        GIT_CHANGES = getChangeSet()
    }
    parameters {
